                           ...
                           <div className="overflow-auto"> <table className="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase border-b-2 border-gray-500 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr className="text-nowrap">
                                        ...
                                        <th onClick={e => sortChanged('name')} className="px-3 py-3">Название</th>
                                        <th onClick={e => sortChanged('status')} className="px-3 py-3">Статус</th>
                                        <th onClick={e => sortChanged('created_at')} className="px-3 py-3">Создан</th>
                                        <th onClick={e => sortChanged('due_date')} className="px-3 py-3">Дедлайн</th>
